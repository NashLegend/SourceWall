...
final class TargetAction extends Action<Target> {
	...
	TargetAction(Picasso picasso, Target target, Request data, boolean skipCache, boolean updateCache, int errorResId,
			Drawable errorDrawable, String key, Object tag) {
		super(picasso, target, data, skipCache, updateCache, false, errorResId, errorDrawable, key, tag);
	}
