...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
	...
	RemoteViewsAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int errorResId,
			boolean skipCache, boolean updateCache, String key, Object tag) {
		super(picasso, null, data, skipCache, updateCache, false, errorResId, null, key, tag);
	...
	static class AppWidgetAction extends RemoteViewsAction {
		...
		AppWidgetAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int[] appWidgetIds,
				boolean skipCache, boolean updateCache, int errorResId, String key, Object tag) {
			super(picasso, data, remoteViews, viewId, errorResId, skipCache, updateCache, key, tag);
	...
	static class NotificationAction extends RemoteViewsAction {
		...
		NotificationAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int notificationId,
				Notification notification, boolean skipCache, boolean updateCache,  int errorResId, String key, Object tag) {
			super(picasso, data, remoteViews, viewId, errorResId, skipCache, updateCache,  key, tag);
