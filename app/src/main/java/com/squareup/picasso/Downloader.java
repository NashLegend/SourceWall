...
public interface Downloader {
	 ...
	 * @param localCacheOnly If {@code true} the URL should only be loaded if
	 *            available in a local disk cache.
	 * @return {@link com.squareup.picasso.Downloader.Response} containing either a {@link android.graphics.Bitmap}
	 *         representation of the request or an {@link java.io.InputStream} for the
	...
	class Response {
		 ...
		 *
		 * @param bitmap Image.
		 * @param loadedFromCache {@code true} if the source of the image is
		 *            from a local disk cache.
		 * @deprecated Use
		 *             {@link com.squareup.picasso.Downloader.Response#Response(android.graphics.Bitmap, boolean, long)}
		 *             instead.
		 */
		@Deprecated
		 ...
		 * @param loadedFromCache {@code true} if the source of the stream is
		 *            from a local disk cache.
		 * @deprecated Use
		 *             {@link com.squareup.picasso.Downloader.Response#Response(java.io.InputStream, boolean, long)}
		 *             instead.
		 */
		@Deprecated
		@SuppressWarnings("UnusedDeclaration")
		 ...
		 * @param loadedFromCache {@code true} if the source of the image is
		 *            from a local disk cache.
		 * @param contentLength The content length of the response, typically
		 *            derived by the {@code Content-Length} HTTP header.
		 */
