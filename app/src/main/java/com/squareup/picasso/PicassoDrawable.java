...
final class PicassoDrawable extends BitmapDrawable {
	...
	/**
	 * Create or update the drawable on the target {@link android.widget.ImageView} to display
	 * the supplied bitmap image.
	 */
	static void setBitmap(ImageView target, Context context, Bitmap bitmap, Picasso.LoadedFrom loadedFrom,
	...
	PicassoDrawable(Context context, Bitmap bitmap, Drawable placeholder, Picasso.LoadedFrom loadedFrom,
			boolean noFade, boolean debugging) {
