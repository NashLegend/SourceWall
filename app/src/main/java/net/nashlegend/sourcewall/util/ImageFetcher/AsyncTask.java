...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link net.nashlegend.sourcewall.util.ImageFetcher.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *                               {@link net.nashlegend.sourcewall.util.ImageFetcher.AsyncTask.Status#RUNNING} or {@link net.nashlegend.sourcewall.util.ImageFetcher.AsyncTask.Status#FINISHED}.
