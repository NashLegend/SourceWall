...
public class SimpleHttp {
    ...
    public static ResponseObject<String> get(String url, ParamsMap params) throws Exception {
    ...
    public static ResponseObject<String> post(String url, ParamsMap params) throws Exception {
    ...
    public static ResponseObject<String> put(String url, ParamsMap params) throws Exception {
    ...
    public static ResponseObject<String> delete(String url, ParamsMap params) throws Exception {
